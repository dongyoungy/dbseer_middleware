...
/**
 * The re-written Tailer class from apache IO to suit our purposes.
...
public class LogTailer implements Runnable
{
	...
	public LogTailer(File file, LogTailerListener listener, long delayMillis, long startOffset)
	{
		this.file = file;
